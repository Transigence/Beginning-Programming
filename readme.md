...
You will forget how to open a file in Python. You will also forget how to search for a substring in a string, or join a list of strings together. You will forget the conversion specifier for floating points when you want to see two leading zeroes and three places of precision. You will forget how to declare a struct in C and you will definitely forget the arguments to `CreateWindowEx()`. Not only will you forget, you will forget sooner than you think.
